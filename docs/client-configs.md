...
- **Status Dashboard:** `https://gemini-web-bridge.taijustarrett417.workers.dev/` (Public)
- **OpenAI Compatible API:** `https://gemini-web-bridge.taijustarrett417.workers.dev/v1`
- **MCP Endpoint:** `https://gemini-web-bridge.taijustarrett417.workers.dev/mcp`
- **WebSocket Bridge:** `wss://gemini-web-bridge.taijustarrett417.workers.dev/bridge`
...
### cURL
```bash
curl -N -X POST https://gemini-web-bridge.taijustarrett417.workers.dev/v1/chat/completions \
